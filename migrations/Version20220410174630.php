 ...
 */
final class Version20220410174630 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT NOT NULL, post_label VARCHAR(255) NOT NULL, post_img VARCHAR(255) NOT NULL, post_data VARCHAR(8) NOT NULL, post_trailer VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
